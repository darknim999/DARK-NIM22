...
if (fs.existsSync('./Themes/' + Config.LANG + '.json')) {var json = JSON.parse(fs.readFileSync('./Themes/' + Config.LANG + '.json'));	} 
else { var json = JSON.parse(fs.readFileSync('./Themes/NIM.json'));}	
...
function tlang() {  let LangG = getString("global");  return LangG;  }	
