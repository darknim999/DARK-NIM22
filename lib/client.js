...
try {
    ...
    console.log("🌍 Connected to the DARK NIM DB")
} catch {
...
let cc = Config.sessionName.replace(/ /gi, ""); // Dont Remove "Secktor;;;" So that You Can Use Secktor Qr too in your bot
